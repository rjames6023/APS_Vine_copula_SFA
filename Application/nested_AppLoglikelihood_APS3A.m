function [logMLE, theta, sterr, u_hat, V_u_hat, non_par_u_hat, u_hat_conditional_w2w3, V_u_hat_conditional_w2w3] = nested_AppLoglikelihood_APS3A(y, x1, x2, x3, p1, p2, p3, us, theta0)
...
%     [theta, logMLE] = run(gs, problem);
    ...
    for i=1:length(theta)
        ...
        grad(:,i) = (AppLogDen_APS3A(theta1, 0) - AppLogDen_APS3A(theta, 0))/delta; 
    end
